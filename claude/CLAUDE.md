...
- 複数プロジェクトで共有する CLAUDE.md 断片は `~/dotfiles/claude/fragments/` に置き、必要なプロジェクトの CLAUDE.md（チームリポでは git 管理外の CLAUDE.local.md）から `@~/dotfiles/claude/fragments/<名前>.md` で import する。web プロジェクトを新規セットアップする際は `portless.md` の import を提案する
